            ...
            <div class="well">
                ...
                foreach($_SESSION as $key => $value){
                    if ($count > 2)
                        ...
                        if ($count == 0)
                            echo "<div class=\"row\">";
                            echo "<div class=\"col-sm-4\" id=\"$value" . "col\">" . "<h3 class=\"item\" id=\"$value" . "txt\">" . htmlspecialchars($value) . "</h3>" . "<img src=\"images/$value.jpg\" class=\"img-responsive ui-widget-content item\" id=\"$value\"></div>";
                        if ($count == 2)
                            echo "</div>";
                        $count++;
                }
